...
export default function SDV2() {
  ...
  useGSAP(() => {
    ...
    // Phase 4: ZOOM IN — logo scales up massively, like approaching the driveway
    // Transform origin is at the driveway center (lower-left area of logo)
    ...
    tl.to(titleRef.current, { opacity: 0, duration: 0.5 }, 3);

    // Phase 5: Fade to reveal content behind
    tl.to(logoWrap.current, { opacity: 0, duration: 1 }, 5);
  }, { scope: heroRef });
      ...
      <div className="min-h-screen bg-[#0a0a0a] font-heading-oswald text-white antialiased">
        ...
        <section className="min-h-screen flex items-center justify-center px-8">
          <div className="text-center">
            <p className="text-white/20 text-xs tracking-[0.3em] uppercase mb-4">V2 — The Approach</p>
            <h2 className="text-4xl font-bold tracking-tight text-white/90 mb-4">Driveways built to last</h2>
            <p className="text-white/40 text-lg max-w-md mx-auto">The camera zooms into the driveway — like walking toward the house. The surface fills your view before revealing the page.</p>
          </div>
        </section>
      </div>
    </SmoothScroll>
